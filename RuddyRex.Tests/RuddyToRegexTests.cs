    ...
    public class RuddyToRegexTests
    {
        ...
        public class ConvertorShouldConvertExpression
        {
            ...
            public void WhenPassedEmptyGroupExpression()
            {
                ...
                RegexGroup actual = (RegexGroup)RuddyToRegexConvertor.ConvertTree(abstractTree).First();
            ...
            public void WhenPassedEmptyCharacterRange()
            {
                ...
                RegexCharacterClass actual = (RegexCharacterClass)RuddyToRegexConvertor.ConvertTree(abstractTree).First();
                Assert.AreEqual(expected, actual.Type);
            }
            [TestMethod]
            public void WhenPassedCharacterRange()
            {
                ...
                var actual = (RegexCharacterClass)RuddyToRegexConvertor.ConvertTree(abstractTree).First();
